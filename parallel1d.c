...
int main(int argc, char** argv)
{
    ...
    char* next_local_grid = malloc((local_rows + 2) * cols * sizeof(char));
    
    MPI_Scatter(grid, local_rows * cols, MPI_CHAR, &local_grid[cols], //start at row 1
